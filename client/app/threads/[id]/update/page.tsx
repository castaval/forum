...
const UpdatePage = () => {    
    ...
    return (
        ...
        <div className="py-8 px-4 mx-auto max-w-2xl lg:py-15">
            <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Update thread</h2>
